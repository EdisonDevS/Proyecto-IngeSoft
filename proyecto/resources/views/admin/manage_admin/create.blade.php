	...
	<div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.manage.crear_admin') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="birth_date" type="date" class="form-control @error('name') is-invalid @enderror" name="birth_date" value="{{ old('birthDade') }}" required autofocus>
